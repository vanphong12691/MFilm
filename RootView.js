  ...
  renderScene(route,navigator){
    ...
    switch (route.id) {
      ...
      case Global.Constants.PLAY_ID:
        return (<PlayView navigator={navigator} pageName={route.pageName} typeFilm = {route.typeFilm} type={route.type} quality={route.quality} name={route.name} data={route.data} pages={route.pages} current={route.current} max={route.max} film_id={route.film_id}/>);
